...
public class barangKeluar extends javax.swing.JFrame {
    ...
    public barangKeluar() {
        ...
        String[]row={"Kode Barang","Nama Barang","Jenis","Jumlah","Keterangan"};
    ...
    public void kodeOtomatis(){
        try {
            String sql = "select * from barang_keluar order by kode_brg_keluar desc";
            stat = new fungsi.koneksi().konek.createStatement();
            res = stat.executeQuery(sql);
            if (res.next()) {
                String kode = res.getString("kode_brg_keluar").substring(1);
    ...
    private void initComponents() {
        ...
        setTitle("Input Barang Keluar");

        jPanel1.setBackground(new java.awt.Color(51, 102, 255));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Input Barang Keluar");
        ...
        cmbKet.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        cmbKet.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...PILIH LAB..", "LAB 1", "LAB 2", "LAB 3", "LAB 4", "LAB 5", "LAB 6", "LAB 7" }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(tfNama, javax.swing.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel7)
                    .addComponent(tfJenis, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnUbah)
                    .addComponent(btnHapus)
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        ...
        String keterangan = cmbKet.getSelectedItem().toString();
        ...
        tabModel.setValueAt(keterangan, baris, 4);
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        String jumlah = tfJumlah.getText();
        String keterangan = cmbKet.getSelectedItem().toString();
        String data[] = {kode,nama,jenis,jumlah,keterangan};
    ...
    private void tbDetailMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDetailMouseClicked
        ...
        String keterangan   = tabModel.getValueAt(baris, 4).toString();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try{
            ...
            for(int a=0; a<baris; a++){
                String sql = "insert into barang_keluar (kode_brg_keluar,kode_barang,tanggal,jumlah,keterangan) values (?,?,?,?,?)";
                ...
                prestat.setString(5,tbDetail.getValueAt(a, 4).toString());
